			...
			<ul>
				...
				<li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" >
					...
					<div class="tp-caption banner1 tp-fade tp-resizeme"
						...
						data-end="8700"
						data-endspeed="300"
						style="z-index: 2; max-width: auto; max-height: auto; white-space: nowrap;"><img src="{{ URL::asset('assets/images/slider/slide-2.png') }}" alt="">
					</div>
				...
				<li data-transition="random" data-slotamount="7" data-masterspeed="300" data-title="Slide2" data-saveperformance="off" >
					...
					<div class="tp-caption tp-fade"
						...
						data-endelementdelay="0"
						 data-end="8700"
						data-endspeed="300"
						style="z-index: 3;"><img src="{{ URL::asset('assets/images/slider/slide-1.png') }}" alt="">
					</div>
