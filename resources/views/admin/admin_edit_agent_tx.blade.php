...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Edit Agent Order</li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="row">    
    ...
    <div class="col-lg-12">
      <form class="form-horizontal" role="form" method="POST" action= {{ URL('admin/post/edit/agent/tx') . '/' . $query[0]->order_id . '/' . $query[0]->AId }} >
        {!! csrf_field() !!}
        ...
        <div class="form-group">
            <div class="col-md-offset-3">
                ...
                &nbsp; &nbsp;
                <a href="{{ URL::to('admin/edit/agent') . '/' . $query[0]->AId }}" class="btn btn-default">Cancel</a>
            </div>
        </div>
      </form>
    </div>
