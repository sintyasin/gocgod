...
<section class="content">
  ...
  <div class="row">
    <div class="col-lg-12">
      <form class="form-horizontal" role="form" method="POST" action= {{ URL('admin/post/category') . '/' . $query->category_id }} >
        {!! csrf_field() !!}
        ...
        <div class="form-group">
            <div class="col-md-offset-3">
                ...
                &nbsp; &nbsp;
                <a href="{{ URL::to('admin/category/list') }}" class="btn btn-default">Cancel</a>
            </div>
        </div>
      </form>
    </div>
