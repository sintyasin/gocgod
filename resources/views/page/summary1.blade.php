      ...
      <div id="wrapper_progress">
        ...
        <!-- ================================================================================================ -->
          ...
          <Center>
            ...
            <p class="plxLogin"><font size="3">Total Product Price : Rp {{number_format($orderprice[0]->total_price, 2, ',','.')}}</font> </p>
            <p class="plxLogin"><font size="3">Shipping Fee  : Rp {{number_format(0, 2, ',','.')}}</font> </p>
            <hr>
