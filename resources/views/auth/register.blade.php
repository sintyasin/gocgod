                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('passwords') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="password" class="form-control" placeholder="Input Your Password" name="passwords">
                        ...
                        <div class="form-group{{ $errors->has('passwords_confirmation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="password" class="form-control" placeholder="Input The Same Password" name="passwords_confirmation">
